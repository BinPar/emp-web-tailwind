interface NewCartProps {
  ...
  const NewCart: React.FC<NewCartProps> = ({ className }) => (

    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 11.1 10" fill="currentColor">
    <path d="M9.4,9c0-0.3,0-0.5-0.2-0.7C9.1,8.1,8.9,7.9,8.6,7.9c0.2,0,0.3,0,0.5,0c0.2,0,0.3-0.1,0.3-0.3
