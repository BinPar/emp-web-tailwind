...
const NewLock: React.FC<NewLockProps> = ({ className }) => (
  <svg
  ...
  >
    <path
      d="M9.3,6.4v-1c0-0.1,0-0.3,0-0.4c0-0.4-0.4-0.8-0.8-0.9c0,0-0.1,0-0.1,0l0-0.4c0-0.3,0-0.5,0-0.8
    ...
    />
    <path
      d="M6.1,6C5.9,5.8,5.6,5.7,5.3,5.8C5,5.9,4.7,6.1,4.6,6.4C4.5,6.7,4.5,7,4.7,7.3c0,0,0,0.1,0,0.1
