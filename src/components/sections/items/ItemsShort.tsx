...
const title = ['Experto en Imagen Cardíaca', 'Experto en Resonancia Magnética Musculoesquelética'];
const author = [
...
const ShortItem: React.FC<ShortItemProps> = ({
  ...
  <li className="flex gap-4 items-start pb-5 lg:min-w-[356px]">
    <NormalLink
      href="#"
      className="block min-w-[100px] w-[100px] lg:w-[155px] lg:min-w-[145px] text-center"
    >
      <Image alt="item" src={src} width="1038" height="1046" />
      <TypeP className="lg:hidden inline">{type}</TypeP>
    </NormalLink>
    <div className="pt-1 w-full">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        {initial === '' ? null : (
          <NewItemBadge className="hidden lg:block" initials={initial} fullText={fullText} />
        )}
      </div>
      <InfoWrap>
...
const ItemShort: React.FC = () => {
  ...
  return (
    ...
    <ul className="flex flex-col md:flex-row lg:flex-col lg:pl-12 lg:ml-12 lg:pt-5 pt-8 mt-8 border-t lg:border-t-0 lg:border-l border-gray-200 gap-6">
      {itemsShort}
    </ul>
  );
};
