...
const AuthorItem: React.FC<AuthorItemProps> = ({ src, name, link }) => (
  <li className="flex items-start pb-5 flex-1 lg:flex-col lg:text-center min-w-full sm:min-w-[calc(50%_-_20px)] md:min-w-[calc(33%_-_20px)] lg:min-w-[calc(50%_-_20px)] xl2:min-w-[calc(33%_-_20px)] xl3:min-w-[calc(25%_-_20px)] mr-5  sm:border-r-2 border-gray-300 last:border-r-0">
